...
Usage:   python writeouthosts_rz.py <outpath>
Example: python writeouthosts_rz.py /home/awright/dwarf_stellar_halos/r431/
...
ofile = outpath+cursim+'_halostarhosts.txt'
