...
Usage:   python StoreUniqueHostID_rz.py <outpath>
Example: python StoreUniqueHostID_rz.py /home/awright/dwarf_stellar_halos/r431/ 
...
hsfiles = glob.glob(outpath+cursim+'_stardata_??????.h5')
hostfile = outpath+cursim+'_uniquehalostarhosts.txt'
ofile = outpath+cursim+'_allhalostardata.h5'
